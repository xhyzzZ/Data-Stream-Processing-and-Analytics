...
//        });
    ...
    public static class MyProcessFuntion extends KeyedCoProcessFunction<Tuple, Tuple2<Long, SessionJob>, JobEvent, Tuple2<Long, Integer>> {
        ...
        public void processElement2(JobEvent in, Context ctx, Collector<Tuple2<Long, Integer>> out) throws Exception {
            if (in.eventType.getValue() == 4) {
                ctx.timerService().registerEventTimeTimer(in.timestamp + 1);
            }
        }
